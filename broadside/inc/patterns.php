...
function shadow_digest_register_pattern_categories(): void {
	register_block_pattern_category(
		'digest-article',
		array(
			'label'       => __( 'Broadside — article furniture', 'broadside' ),
			'description' => __( 'The parts of a long read: the opening, the answer box, the contents, the FAQ, the sources.', 'broadside' ),
		)
	);
	...
	register_block_pattern_category(
		'digest-page',
		array(
			'label'       => __( 'Broadside — pages', 'broadside' ),
			'description' => __( 'Whole pages a publication needs: a masthead page, an ethics policy, a contact page.', 'broadside' ),
		)
	);
}
