...
( function ( blocks, element, blockEditor, components, i18n ) {
	...
	blocks.registerBlockType( 'pressroom/short-answer', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;

			var label =
				attributes.label || __( 'The Short Answer', 'pressroom' );
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Short Answer', 'pressroom' ) },
						el( TextControl, {
							label: __( 'Label', 'pressroom' ),
							help: __(
								'The small heading above the answer.',
								'pressroom'
							),
							value: attributes.label,
							placeholder: __( 'The Short Answer', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
	...
	blocks.registerBlockType( 'pressroom/takeaways', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;

			var items = attributes.items || [];
			var label = attributes.label || __( 'Key Takeaways', 'pressroom' );
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Key Takeaways', 'pressroom' ) },

						el( TextControl, {
							label: __( 'Label', 'pressroom' ),
							value: attributes.label,
							placeholder: __( 'Key Takeaways', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
								setAttributes( { label: value } );
							},
						...
						el( RowEditor, {
							items: items,
							addLabel: __( 'Add a takeaway', 'pressroom' ),
							/* translators: %d: the takeaway's position in the list, e.g. "Takeaway 2". */
							rowLabel: __( 'Takeaway %d', 'pressroom' ),
							emptyHint: __(
	...
	blocks.registerBlockType( 'pressroom/toc', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;

			var label = attributes.label || __( 'In This Article', 'pressroom' );
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Table of Contents', 'pressroom' ) },
						el( TextControl, {
							label: __( 'Label', 'pressroom' ),
							value: attributes.label,
							placeholder: __( 'In This Article', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
								setAttributes( { label: value } );
							},
	...
	blocks.registerBlockType( 'pressroom/faq', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;
			...
			var title =
				attributes.title ||
				__( 'Frequently Asked Questions', 'pressroom' );
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'FAQ', 'pressroom' ) },

						el( TextControl, {
							label: __( 'Heading', 'pressroom' ),
						...
						: items.map( function ( item, index ) {
								return el(
									...
									el(
										...
										item.question ||
											__( 'Untitled question', 'pressroom' )
									),
									el(
										'p',
	...
	blocks.registerBlockType( 'pressroom/sources', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;
			...
			var items = attributes.items || [];
			var label =
				attributes.label || __( 'Sources & References', 'pressroom' );
			...
			return el(
				...
				el(
					...
					el(
						...
						el( RowEditor, {
							items: items,
							addLabel: __( 'Add a source', 'pressroom' ),
							/* translators: %d: the source's position in the list, e.g. "Source 3". */
							rowLabel: __( 'Source %d', 'pressroom' ),
							emptyHint: __(
	...
	blocks.registerBlockType( 'pressroom/disclosure-table', {
		edit: function ( props ) {
			var attributes = props.attributes;
			var setAttributes = props.setAttributes;
			...
			var headings = [
				attributes.columnOne || __( 'What to check', 'pressroom' ),
				attributes.columnTwo || __( 'Why it matters', 'pressroom' ),
				attributes.columnThree || __( 'Partner', 'pressroom' ),
			];
			...
			return el(
				...
				el(
					...
					el(
						PanelBody,
						{ title: __( 'Columns', 'pressroom' ) },

						el( TextControl, {
							label: __( 'First column', 'pressroom' ),
							value: attributes.columnOne,
							placeholder: __( 'What to check', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
						...
						el( TextControl, {
							label: __( 'Second column', 'pressroom' ),
							value: attributes.columnTwo,
							placeholder: __( 'Why it matters', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
						...
						el( TextControl, {
							label: __( 'Third column', 'pressroom' ),
							value: attributes.columnThree,
							placeholder: __( 'Partner', 'pressroom' ),
							__nextHasNoMarginBottom: true,
							onChange: function ( value ) {
					...
					el(
						...
						rows.map( function ( row, index ) {
							return el(
								...
								el( TextControl, {
									label: __( 'Partner name', 'pressroom' ),
									value: row.partner || '',
									__nextHasNoMarginBottom: true,
									onChange: function ( value ) {
								...
								el( TextControl, {
									label: __( 'Partner URL', 'pressroom' ),
									type: 'url',
									value: row.url || '',
									__nextHasNoMarginBottom: true,
									onChange: function ( value ) {
						...
						el(
							Button,
							{ variant: 'secondary', onClick: add },
							__( 'Add a row', 'pressroom' )
						)
					),

					el(
						PanelBody,
						{ title: __( 'Disclosure', 'pressroom' ) },
						el( TextareaControl, {
							label: __( 'Disclosure line', 'pressroom' ),
							help: __(
