	...
	<footer <?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'digest-footer' ) ) ); ?>>
			...
			if ( $founded ) {
				printf(
					...
					sprintf(
						...
						esc_html__( 'Founded %d', 'pressroom' ),
						(int) $founded
					)
				);
			}
		...
		<span class="digest-footer__copyright">
			...
			printf(
				...
				esc_html__( '© %1$s · All Rights Reserved', 'pressroom' ),
		...
		<div class="digest-byline-block__when">
			<div>
				...
				printf(
					...
					esc_html__( 'Published %s', 'pressroom' ),
			...
			<?php if ( shadow_digest_get( 'shadow_digest_reading_time' ) ) : ?>
				<div>
					...
					printf(
						...
						esc_html( _n( '%d-minute read', '%d-minute read', $minutes, 'pressroom' ) ),
						(int) $minutes
					);
					?>
				</div>
...
function shadow_digest_render_author_bio(): string {
	...
	<section <?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'digest-author-bio' ) ) ); ?> id="author">
		...
		<div>
			<p class="digest-author-bio__label"><?php esc_html_e( 'About the Author', 'pressroom' ); ?></p>
...
function shadow_digest_user_role_field( WP_User $user ): void {
	?>
	<h2><?php esc_html_e( 'Pressroom', 'pressroom' ); ?></h2>

	<table class="form-table" role="presentation">
		<tr>
			<th>
				<label for="shadow_digest_role"><?php esc_html_e( 'Masthead title', 'pressroom' ); ?></label>
			</th>
			<td>
				<input
					type="text"
				...
				/>
				<p class="description">
					<?php esc_html_e( 'Printed after the name in the byline — “Chief Correspondent”, “Science Editor”, “Contributing Writer”.', 'pressroom' ); ?>
				</p>
			</td>
		</tr>
	</table>
