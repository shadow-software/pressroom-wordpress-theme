	...
	<footer <?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'digest-footer' ) ) ); ?>>
			...
			if ( $founded ) {
				printf(
					...
					sprintf(
						...
						esc_html__( 'Founded %d', 'shadow-software-digest-theme-for-wordpress' ),
						(int) $founded
					)
				);
			}
		...
		<span class="digest-footer__copyright">
			...
			printf(
				...
				esc_html__( '© %1$s · All Rights Reserved', 'shadow-software-digest-theme-for-wordpress' ),
		...
		<div class="digest-byline-block__who">
			<span>
				...
				printf(
					...
					esc_html__( 'By %s', 'shadow-software-digest-theme-for-wordpress' ),
		...
		<div class="digest-byline-block__when">
			<div>
				...
				printf(
					...
					esc_html__( 'Published %s', 'shadow-software-digest-theme-for-wordpress' ),
			...
			<?php if ( shadow_digest_get( 'shadow_digest_reading_time' ) ) : ?>
				<div>
					...
					printf(
						...
						esc_html( _n( '%d-minute read', '%d-minute read', $minutes, 'shadow-software-digest-theme-for-wordpress' ) ),
						(int) $minutes
					);
					?>
				</div>
...
function shadow_digest_render_author_bio(): string {
	...
	<section <?php echo wp_kses_data( get_block_wrapper_attributes( array( 'class' => 'digest-author-bio' ) ) ); ?> id="author">
		...
		<div>
			<p class="digest-author-bio__label"><?php esc_html_e( 'About the Author', 'shadow-software-digest-theme-for-wordpress' ); ?></p>
...
function shadow_digest_user_role_field( WP_User $user ): void {
	?>
	<h2><?php esc_html_e( 'Digest', 'shadow-software-digest-theme-for-wordpress' ); ?></h2>

	<table class="form-table" role="presentation">
		<tr>
			<th>
				<label for="shadow_digest_role"><?php esc_html_e( 'Masthead title', 'shadow-software-digest-theme-for-wordpress' ); ?></label>
			</th>
			<td>
				<input
					type="text"
				...
				/>
				<p class="description">
					<?php esc_html_e( 'Printed after the name in the byline — “Chief Correspondent”, “Science Editor”, “Contributing Writer”.', 'shadow-software-digest-theme-for-wordpress' ); ?>
				</p>
			</td>
		</tr>
	</table>
