...
function shadow_digest_register_pattern_categories(): void {
	register_block_pattern_category(
		'digest-article',
		array(
			'label'       => __( 'Digest — article furniture', 'shadow-software-digest-theme-for-wordpress' ),
			'description' => __( 'The parts of a long read: the opening, the answer box, the contents, the FAQ, the sources.', 'shadow-software-digest-theme-for-wordpress' ),
		)
	);
	...
	register_block_pattern_category(
		'digest-page',
		array(
			'label'       => __( 'Digest — pages', 'shadow-software-digest-theme-for-wordpress' ),
			'description' => __( 'Whole pages a publication needs: a masthead page, an ethics policy, a contact page.', 'shadow-software-digest-theme-for-wordpress' ),
		)
	);
}
